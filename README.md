...
3. Follow the instructions here to open your config file: https://github.com/ipfs/go-ipfs/blob/master/docs/config.md. Usually it's `~/.ipfs/config` on Linux. Add the <a href="http://bafybeibz4qdtifprtwty3zgiymjje4h5q6m4omyvg3ulomnpj26rboskxy.ipfs.localhost:8080/">APP URL</a> to the `Access-Control-Allow-Origin` list
4. Navigate to <a href="http://bafybeibz4qdtifprtwty3zgiymjje4h5q6m4omyvg3ulomnpj26rboskxy.ipfs.localhost:8080/">APP URL</a> and enjoy
